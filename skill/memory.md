...
- `source` *(optional)*: Filter by tool — `"opencode"`, `"claude-code"`, `"cursor"`, or `"vscode"`. Omit to search across all.
...
- Sessions from OpenCode, Claude Code, Cursor, and VS Code are indexed into the **same** database.
